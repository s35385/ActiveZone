public class PersonalTrainingPlan extends MembershipPlan {
    ...
    public PersonalTrainingPlan(String planCode, String clientName, int months, double baseMonthlyFee,
                                boolean autoRenew, int sessionsPerMonth, int trainerLevel, boolean dietConsultationIncluded) {
    ...
    public String toString() {
        return super.toString() + ", Sessions: " + sessionsPerMonth + ", Trainer Lvl: " + trainerLevel;
    }
}